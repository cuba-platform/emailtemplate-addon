...
public class EmailSender implements EmailSenderAPI {
    ...
    @Override
    public void sendEmail(ExtendedSendingMessage sendingMessage) throws MessagingException {
    ...
    protected MimeMessage createMimeMessage(ExtendedSendingMessage sendingMessage) throws MessagingException {
    ...
    protected void setMimeMessageContent(ExtendedSendingMessage sendingMessage, MimeMultipart content, MimeMultipart textPart)
    ...
    protected void assignFromAddress(ExtendedSendingMessage sendingMessage, MimeMessage msg) throws MessagingException {
    ...
    private void addHeaders(ExtendedSendingMessage sendingMessage, MimeMessage message) throws MessagingException {
        if (sendingMessage.getHeaders() == null)
            return;
        String[] splitHeaders = sendingMessage.getHeaders().split(ExtendedSendingMessage.HEADERS_SEPARATOR);
