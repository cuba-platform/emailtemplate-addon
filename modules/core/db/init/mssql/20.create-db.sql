...
create unique index IDX_EMAILTEMPLATES_TEMPLATE_BLOCK_UNIQ_NAME on EMAILTEMPLATES_TEMPLATE_BLOCK (NAME, DELETE_TS) ^
...
-- begin EMAILTEMPLATES_TEMPLATE_BLOCK
create unique index IDX_EMAILTEMPLATES_BLOCK_GROUP_UNIQ_NAME on EMAILTEMPLATES_BLOCK_GROUP (NAME, DELETE_TS) ^
-- end EMAILTEMPLATES_TEMPLATE_BLOCK
