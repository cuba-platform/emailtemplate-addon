...
public class YetTestContainer extends TestContainer {

    public YetTestContainer() {
        super();
    ...
    public static class Common extends YetTestContainer {

        public static final YetTestContainer.Common INSTANCE = new YetTestContainer.Common();
